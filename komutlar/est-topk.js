...
message.channel.send(new Discord.MessageEmbed().setAuthor(message.author.tag, message.author.avatarURL({dynamic:true})).setTitle(yazı).setTimestamp().setColor("RANDOM").setFooter("JetSkiciler ❤").setDescription(top));
